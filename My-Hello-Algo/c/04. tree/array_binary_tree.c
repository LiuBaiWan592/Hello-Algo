/**
 * @FileName    :array_binary_tree.c
 * @Date        :2024-09-03 10:59:24
 * @Author      :LiuBaiWan (https://github.com/LiuBaiWan592)
 * @Version     :V1.0.0
 * @Brief       :二叉树的数组表示
 * @Description :父节点索引与子节点索引之间的“映射公式”：若某节点的索引为 i ，则该节点的左子节点索引为 2i + 1 ，右子节点索引为 2i +2
 *               将所有原来的左右节点指针工作转化为求节点的索引
 *               Copy from orign file
 */
